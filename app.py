...
def load_data():
    ...
    LEFT JOIN matches m ON s.player_id = m.player_id;
    """
...
# Searchable Region Selector (Supports typing/searching NA, SA, ME, OCE, APAC, LATAM, EU)
...
with col1:
    ...
    if not filtered_df.empty:
        ...
        # 30 bins prevents solid purple block artifacts
        sns.histplot(
            data=filtered_df, 
            x="ping_ms", 
            bins=30, 
